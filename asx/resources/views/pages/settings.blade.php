                    ...
                    <div class="row">
                        <div class="col-lg-12  portfolio-tile portfolio-body-top-tile" id="port-recent-panel">
                            ...
                            <div class="col-lg-5 col-lg-offset-1 FAQ_container">
                                ...
                                <h3 class="text-center faq-manual"><strong>All questions can be answered in the User Manual. Download it <a href="{{ URL::to('/files/userMan.pdf') }} " target="_blank">here.</a></strong></h3>
                            </div>
